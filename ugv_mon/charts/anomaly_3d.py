...
def create_anomaly_3d_scatter(
    ...
    fig.update_layout(
        scene=dict(
            xaxis=dict(title="지터 (ms)", gridcolor="#444", zerolinecolor="#666"),
            yaxis=dict(title="PPS", gridcolor="#444", zerolinecolor="#666"),
            zaxis=dict(title="손실률 (%)", gridcolor="#444", zerolinecolor="#666"),
...
def _create_empty_figure() -> go.Figure:
    ...
    fig.update_layout(
        scene=dict(
            xaxis=dict(title="지터 (ms)"),
            yaxis=dict(title="PPS"),
            zaxis=dict(title="손실률 (%)"),
        ),
